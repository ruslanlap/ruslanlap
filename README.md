...
<!-- TOTAL_DL_START -->
**Total downloads across my plugins:** **15 816** 🚀

**Monthly Growth:** +14.5% 📈 | **Weekly Avg:** 361 downloads

### 🏆 Top Performing Plugins

| 🏅 Rank | Plugin | Downloads | Share of Total | Latest Release |
|---------|--------|-----------|----------------|----------------|
| 🥇 | 🎥 **[Video Downloader](https://github.com/ruslanlap/PowerToysRun-VideoDownloader)** | 4,364 | 27.6% | v1.0.11 (Sep 05, 2025) |
| 🥈 | ⚡ **[Speed Test](https://github.com/ruslanlap/PowerToysRun-SpeedTest)** | 4,342 | 27.5% | v1.0.7 (Sep 09, 2025) |
| 🥉 | 📚 **[Definition](https://github.com/ruslanlap/PowerToysRun-Definition)** | 1,770 | 11.2% | v1.2.1 (Jul 08, 2025) |
| 4️⃣ | 🌤️ **[Weather](https://github.com/ruslanlap/PowerToysRun-Weather)** | 1,310 | 8.3% | v0.90.1 (Apr 28, 2025) |
| 5️⃣ | 🍅 **[Pomodoro](https://github.com/ruslanlap/PowerToysRun-Pomodoro)** | 1,304 | 8.2% | v0.90.1 (Apr 28, 2025) |

*📊 Smart analytics updated weekly via automated workflows • Last updated: Nov 09, 2025*
...
### 🎯 Key Metrics
- **Total Downloads**: 15,816 across all plugins
- **Active Plugins**: 21 repositories with downloads
- **Average per Active Plugin**: 753 downloads
- **Top Performer**: Video Downloader (27.6% of total downloads)
- **Top 5 Combined**: 13,090 (82.8% of total downloads)
