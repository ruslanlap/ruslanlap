...
<!-- TOTAL_DL_START -->
**Total downloads across my plugins:** **16 633** 🚀

**Monthly Growth:** +12.4% 📈 | **Weekly Avg:** 403 downloads

### 🏆 Top Performing Plugins

| 🏅 Rank | Plugin | Downloads | Share of Total | Latest Release |
|---------|--------|-----------|----------------|----------------|
| 🥇 | 🎥 **[Video Downloader](https://github.com/ruslanlap/PowerToysRun-VideoDownloader)** | 4,503 | 27.1% | v1.0.11 (Sep 05, 2025) |
| 🥈 | ⚡ **[Speed Test](https://github.com/ruslanlap/PowerToysRun-SpeedTest)** | 4,500 | 27.1% | v1.0.7 (Sep 09, 2025) |
| 🥉 | 📚 **[Definition](https://github.com/ruslanlap/PowerToysRun-Definition)** | 1,860 | 11.2% | v1.2.1 (Jul 08, 2025) |
| 4️⃣ | 🍅 **[Pomodoro](https://github.com/ruslanlap/PowerToysRun-Pomodoro)** | 1,401 | 8.4% | v0.90.1 (Apr 28, 2025) |
| 5️⃣ | 🌤️ **[Weather](https://github.com/ruslanlap/PowerToysRun-Weather)** | 1,389 | 8.4% | v0.90.1 (Apr 28, 2025) |

*📊 Smart analytics updated weekly via automated workflows • Last updated: Nov 23, 2025*
...
### 🎯 Key Metrics
- **Total Downloads**: 16,633 across all plugins
- **Active Plugins**: 25 repositories with downloads
- **Average per Active Plugin**: 665 downloads
- **Top Performer**: Video Downloader (27.1% of total downloads)
- **Top 5 Combined**: 13,653 (82.1% of total downloads)
