...
<!-- TOTAL_DL_START -->
**Total downloads across my plugins:** **16 244** 🚀

**Monthly Growth:** +13.0% 📈 | **Weekly Avg:** 407 downloads

### 🏆 Top Performing Plugins

| 🏅 Rank | Plugin | Downloads | Share of Total | Latest Release |
|---------|--------|-----------|----------------|----------------|
| 🥇 | ⚡ **[Speed Test](https://github.com/ruslanlap/PowerToysRun-SpeedTest)** | 4,428 | 27.3% | v1.0.7 (Sep 09, 2025) |
| 🥈 | 🎥 **[Video Downloader](https://github.com/ruslanlap/PowerToysRun-VideoDownloader)** | 4,428 | 27.3% | v1.0.11 (Sep 05, 2025) |
| 🥉 | 📚 **[Definition](https://github.com/ruslanlap/PowerToysRun-Definition)** | 1,821 | 11.2% | v1.2.1 (Jul 08, 2025) |
| 4️⃣ | 🌤️ **[Weather](https://github.com/ruslanlap/PowerToysRun-Weather)** | 1,353 | 8.3% | v0.90.1 (Apr 28, 2025) |
| 5️⃣ | 🍅 **[Pomodoro](https://github.com/ruslanlap/PowerToysRun-Pomodoro)** | 1,349 | 8.3% | v0.90.1 (Apr 28, 2025) |

*📊 Smart analytics updated weekly via automated workflows • Last updated: Nov 16, 2025*
...
### 🎯 Key Metrics
- **Total Downloads**: 16,244 across all plugins
- **Active Plugins**: 25 repositories with downloads
- **Average per Active Plugin**: 650 downloads
- **Top Performer**: Speed Test (27.3% of total downloads)
- **Top 5 Combined**: 13,379 (82.4% of total downloads)
