...
<!-- TOTAL_DL_START -->
**Total downloads across my plugins:** **20 839** 🚀

**Monthly Growth:** +3.0% 📈 | **Weekly Avg:** 171 downloads

### 🏆 Top Performing Plugins

| 🏅 Rank | Plugin | Downloads | Share of Total | Latest Release |
|---------|--------|-----------|----------------|----------------|
| 🥇 | 🎥 **[Video Downloader](https://github.com/ruslanlap/PowerToysRun-VideoDownloader)** | 5,352 | 25.7% | v1.0.12 (Jan 21, 2026) |
| 🥈 | ⚡ **[Speed Test](https://github.com/ruslanlap/PowerToysRun-SpeedTest)** | 5,281 | 25.3% | v1.0.7 (Sep 09, 2025) |
| 🥉 | 📚 **[Definition](https://github.com/ruslanlap/PowerToysRun-Definition)** | 2,410 | 11.6% | v1.4.0 (Mar 18, 2026) |
| 4️⃣ | 🍅 **[Pomodoro](https://github.com/ruslanlap/PowerToysRun-Pomodoro)** | 1,755 | 8.4% | v0.90.1 (Apr 28, 2025) |
| 5️⃣ | 🌤️ **[Weather](https://github.com/ruslanlap/PowerToysRun-Weather)** | 1,675 | 8.0% | v0.90.1 (Apr 28, 2025) |

*📊 Smart analytics updated weekly via automated workflows • Last updated: Mar 29, 2026*
...
### 🎯 Key Metrics
- **Total Downloads**: 20,839 across all plugins
- **Active Plugins**: 25 repositories with downloads
- **Average per Active Plugin**: 834 downloads
- **Top Performer**: Video Downloader (25.7% of total downloads)
- **Top 5 Combined**: 16,473 (79.0% of total downloads)
